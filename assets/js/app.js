function renderizarIcones() {
    const iconElements = document.querySelectorAll('.iconContainer');

    iconElements.forEach(iconElement => {
        const className = iconElement.parentElement.className;
...
// Defina a constante Icons com os ícones aqui
